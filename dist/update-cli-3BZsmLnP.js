...
import { c as writeConfigFile, o as readConfigFileSnapshot } from "./config-BciOrS2p.js";
import "./manifest-registry-Bwjq9Iev.js";
import { t as formatDocsLink } from "./links-B4nk2iDf.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-CFsleyxV.js";
import "./note-_C44YfAQ.js";
import "./archive-ccN9aDgq.js";
import "./installs-BP4K5L33.js";
import { o as trimLogTail } from "./restart-sentinel-Cr0vUxB8.js";
import "./register.subclis-B7EvLlxy.js";
import { r as installCompletion } from "./completion-cli-BzY-E2tK.js";
import { r as parseSemver } from "./runtime-guard-X5t_VXaZ.js";
import { t as renderTable } from "./table-2ulSuXr0.js";
import { _ as formatUpdateChannelLabel, a as globalInstallArgs, d as compareSemverStrings, f as fetchNpmTagVersion, g as channelToNpmTag, h as DEFAULT_PACKAGE_CHANNEL, i as detectGlobalInstallManagerForRoot, l as ensureCompletionCacheExists, m as DEFAULT_GIT_CHANNEL, n as cleanupGlobalRenameDirs, o as resolveGlobalPackageRoot, p as resolveNpmChannelTag, r as detectGlobalInstallManagerByPresence, s as checkShellCompletionStatus, t as runGatewayUpdate, u as checkUpdateStatus, v as normalizeUpdateChannel, y as resolveEffectiveUpdateChannel } from "./update-runner-CQHkL_bo.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-Bk45TwI4.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-JpJkww5g.js";
...
async function updateCommand(opts) {
	...
	if (shouldRestart) {
		...
		try {
			const { runDaemonRestart } = await import("./daemon-cli-CFqIu2bi.js").then((n) => n.t);
			...
			if (!opts.json && restarted) {
				...
				try {
					const { doctorCommand } = await import("./doctor-D10tTcRF.js").then((n) => n.n);
