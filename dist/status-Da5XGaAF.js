...
import { _ as ensureAuthProfileStore, ht as DEFAULT_PROVIDER, j as resolveConfiguredModelRef, mt as DEFAULT_MODEL, pt as DEFAULT_CONTEXT_TOKENS } from "./auth-profiles-BPf6QUS2.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-ayFsmwwz.js";
import { H as parseAgentSessionKey, N as normalizeAgentId, c as resolveDefaultAgentId, h as DEFAULT_IDENTITY_FILENAME, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-C_O6Vpl0.js";
...
import { c as writeConfigFile, i as loadConfig, j as VERSION, o as readConfigFileSnapshot } from "./config-BciOrS2p.js";
import { f as inspectPortUsage, m as formatPortDiagnostics } from "./errors-CMCg46fK.js";
import { a as findTailscaleBinary, o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-DCnMs7_q.js";
...
import { o as resolveStorePath } from "./paths-CHGbP1-A.js";
import { I as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-Cf9YkzWv.js";
import { t as buildChannelSummary } from "./channel-summary-D9NTAHkN.js";
import { a as summarizeRestartSentinel, i as readRestartSentinel } from "./restart-sentinel-Cr0vUxB8.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-ZcR1U-m5.js";
import { r as installCompletion } from "./completion-cli-BzY-E2tK.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-C1I751F4.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-2b1kQ450.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-BJ-PZAXC.js";
import { o as readLastGatewayErrorLine } from "./service-audit-ACLEyCEM.js";
import { t as renderTable } from "./table-2ulSuXr0.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-CzFjZ0nl.js";
import { d as applyAuthChoice, h as ensureControlUiAssetsBuilt, l as resolvePreferredProviderForAuthChoice, m as promptAuthChoiceGrouped, o as applyPrimaryModel, r as promptRemoteGatewayConfig, s as promptDefaultModel, t as setupSkills, u as warnIfModelConfigLooksOff } from "./onboard-skills-Dnvd2qXm.js";
import { a as resolveHeartbeatSummaryForAgent, i as healthCommand, n as formatHealthChannelLines, t as formatHealthCheckFailure } from "./health-format-DoimNs4E.js";
import { _ as formatUpdateChannelLabel, d as compareSemverStrings, l as ensureCompletionCacheExists, s as checkShellCompletionStatus, u as checkUpdateStatus, v as normalizeUpdateChannel, y as resolveEffectiveUpdateChannel } from "./update-runner-CQHkL_bo.js";
import { n as logConfigUpdated } from "./logging-C6k_H0a0.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-B6XRTrOh.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-68SV0Ams.js";
import { t as runTui } from "./tui-Dd2oA_0i.js";
import { t as resolveNodeService } from "./node-service-Cy7Xs3vY.js";
import { i as redactSecrets, n as formatDuration$1, r as formatGatewayAuthUsed, t as formatAge$1 } from "./format-BC7_EepG.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-Bk45TwI4.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-C6GGQ-sU.js").then((n) => n.r);
