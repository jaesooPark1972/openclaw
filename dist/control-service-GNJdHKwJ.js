...
import { S as ensureChromeExtensionRelayServer } from "./chrome-D7QROrKP.js";
import { a as resolveProfile, i as resolveBrowserConfig, t as createBrowserRouteContext } from "./server-context-mXWLR983.js";
...
async function stopBrowserControlService() {
	...
	state = null;
	try {
		await (await import("./pw-ai-DVVrUUrw.js")).closePlaywrightBrowserConnection();
	} catch {}
}
