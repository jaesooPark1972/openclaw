...
import { D as DEFAULT_AGENT_ID, a as resolveAgentModelPrimary } from "./agent-scope-C_O6Vpl0.js";
import { m as resolveUserPath } from "./utils-DX85MiPR.js";
import { a as saveJsonFile, i as loadJsonFile, r as resolveCopilotApiToken, t as DEFAULT_COPILOT_API_BASE_URL } from "./github-copilot-token-C8XFYz0i.js";
...
//#endregion
export { requireApiKey as $, resolveAllowedModelRef as A, resolveImplicitBedrockProvider as B, buildAllowedModelSet as C, modelKey as D, isCliProvider as E, resolveThinkingDefault as F, VENICE_MODEL_CATALOG as G, resolveImplicitProviders as H, XIAOMI_DEFAULT_MODEL_ID as I, SYNTHETIC_DEFAULT_MODEL_REF as J, buildVeniceModelDefinition as K, buildXiaomiProvider as L, resolveDefaultModelForAgent as M, resolveHooksGmailModel as N, normalizeProviderId as O, resolveModelRefFromString as P, getCustomProviderApiKey as Q, normalizeGoogleModelId as R, resolveOpenClawAgentDir as S, getModelRefStatus as T, VENICE_BASE_URL as U, resolveImplicitCopilotProvider as V, VENICE_DEFAULT_MODEL_REF as W, buildSyntheticModelDefinition as X, SYNTHETIC_MODEL_CATALOG as Y, getApiKeyForModel as Z, ensureAuthProfileStore as _, CLAUDE_CLI_PROFILE_ID as _t, markAuthProfileUsed as a, getShellPathFromLoginShell as at, resolveAuthStorePath as b, CHUTES_AUTHORIZE_ENDPOINT as c, shouldDeferShellEnvFallback as ct, parseOAuthCallbackInput as d, buildCloudflareAiGatewayModelDefinition as dt, resolveApiKeyForProvider as et, repairOAuthProfileIdMismatch as f, resolveCloudflareAiGatewayBaseUrl as ft, upsertAuthProfile as g, resolveAuthProfileDisplayLabel as gt, setAuthProfileOrder as h, DEFAULT_PROVIDER as ht, markAuthProfileFailure as i, getShellEnvAppliedKeys as it, resolveConfiguredModelRef as j, parseModelRef as k, exchangeChutesCodeForTokens as l, shouldEnableShellEnvFallback as lt, markAuthProfileGood as m, DEFAULT_MODEL as mt, resolveAuthProfileOrder as n, resolveEnvApiKey as nt, resolveProfileUnusableUntilForDisplay as o, loadShellEnvFallback as ot, listProfilesForProvider as p, DEFAULT_CONTEXT_TOKENS as pt, SYNTHETIC_BASE_URL as q, isProfileInCooldown as r, resolveModelAuthMode as rt, resolveApiKeyForProfile as s, resolveShellEnvFallbackTimeoutMs as st, auth_profiles_exports as t, resolveAwsSdkEnvVarName as tt, generateChutesPkce as u, CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF as ut, loadAuthProfileStore as v, CODEX_CLI_PROFILE_ID as vt, buildModelAliasIndex as w, resolveAuthStorePathForDisplay as x, updateAuthProfileStoreWithLock as y, normalizeProviders as z };