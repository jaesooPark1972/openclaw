...
import { c as writeConfigFile, o as readConfigFileSnapshot } from "./config-Qw6Mvhjh.js";
import "./manifest-registry-D2Yntqcb.js";
import { t as formatDocsLink } from "./links-DwjRqxgR.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-DYJdrXyV.js";
import { o as trimLogTail } from "./restart-sentinel-DUemCjgU.js";
import { r as parseSemver } from "./runtime-guard-68M_evhb.js";
import "./note-CQhSvgQv.js";
import "./archive-CWrnG1CH.js";
import "./installs-DOpTt7VZ.js";
import { _ as formatUpdateChannelLabel, a as globalInstallArgs, d as compareSemverStrings, f as fetchNpmTagVersion, g as channelToNpmTag, h as DEFAULT_PACKAGE_CHANNEL, i as detectGlobalInstallManagerForRoot, l as ensureCompletionCacheExists, m as DEFAULT_GIT_CHANNEL, n as cleanupGlobalRenameDirs, o as resolveGlobalPackageRoot, p as resolveNpmChannelTag, r as detectGlobalInstallManagerByPresence, s as checkShellCompletionStatus, t as runGatewayUpdate, u as checkUpdateStatus, v as normalizeUpdateChannel, y as resolveEffectiveUpdateChannel } from "./update-runner-QzzUA0KV.js";
import { t as renderTable } from "./table-DS4-gmkV.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-lRMVWCDJ.js";
import { r as installCompletion } from "./completion-cli-BcR-O5fC.js";
import { t as formatHelpExamples } from "./help-format-CEsRHU2f.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-CRpHtCgz.js";
...
async function updateCommand(opts) {
	...
	if (shouldRestart) {
		...
		try {
			const { runDaemonRestart } = await import("./daemon-cli-AtW7NJEw.js").then((n) => n.t);
			...
			if (!opts.json && restarted) {
				...
				try {
					const { doctorCommand } = await import("./doctor-CWofvlwz.js").then((n) => n.n);
