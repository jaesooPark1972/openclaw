...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-COTtei4a.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-COTtei4a.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { resolveBootstrapMaxChars as $, isWhatsAppGroupJid as $n, resolveChannelResetConfig as $t, resolveSandboxRuntimeStatus as A, looksLikeSlackTargetId as An, resolveChannelGroupToolsPolicy as Ar, isAudioFileName as At, applySkillEnvOverrides as B, resolveBlueBubblesGroupToolPolicy as Bn, recordSessionMetaFromInbound as Bt, isRawApiErrorPayload as C, listDiscordDirectoryPeersFromConfig as Cn, listDiscordAccountIds as Cr, hasAlphaChannel as Ct, sanitizeUserFacingText as D, listTelegramDirectoryPeersFromConfig as Dn, normalizeDiscordToken as Dr, extensionForMime as Dt, parseImageSizeError as E, listTelegramDirectoryGroupsFromConfig as En, resolveDiscordAccount as Er, detectMime as Et, buildWorkspaceSkillCommandSpecs as F, ensureTargetId as Fn, mediaKindFromMime as Ft, collectExplicitAllowlist as G, resolveIMessageGroupRequireMention as Gn, resolveCacheTtlMs as Gt, resolveSandboxConfigForAgent as H, resolveDiscordGroupToolPolicy as Hn, updateSessionStore as Ht, buildWorkspaceSkillSnapshot as I, requireTargetKind as In, appendAssistantMessageToSessionTranscript as It, normalizeToolName as J, resolveSlackGroupToolPolicy as Jn, mergeDeliveryContext as Jt, expandPolicyWithPluginGroups as K, resolveIMessageGroupToolPolicy as Kn, deliveryContextFromSession as Kt, loadWorkspaceSkillEntries as L, getChannelDock as Ln, resolveMirroredTranscriptText as Lt, registerBrowserRoutes as M, parseSlackTarget as Mn, kindFromMime as Mt, resolveBrowserConfig as N, resolveSlackChannelId as Nn, MAX_IMAGE_BYTES$1 as Nt, ensureSandboxWorkspaceForSession as O, listWhatsAppDirectoryGroupsFromConfig as On, resolveChannelGroupPolicy as Or, getFileExtension as Ot, resolveProfile as P, buildMessagingTarget as Pn, maxBytesForKind as Pt, ensureSessionHeader as Q, resolveWhatsAppGroupToolPolicy as Qn, evaluateSessionFreshness as Qt, resolveSkillsPromptForRun as R, listChannelDocks as Rn, loadSessionStore as Rt, isRateLimitAssistantError as S, listDiscordDirectoryGroupsFromConfig as Sn, resolveIMessageAccount as Sr, getImageMetadata as St, parseImageDimensionError as T, listSlackDirectoryPeersFromConfig as Tn, resolveDefaultDiscordAccountId as Tr, resizeToJpeg as Tt, applyOwnerOnlyToolPolicy as U, resolveGoogleChatGroupRequireMention as Un, updateSessionStoreEntry as Ut, applySkillEnvOverridesFromSnapshot as V, resolveDiscordGroupRequireMention as Vn, updateLastRoute as Vt, buildPluginToolGroups as W, resolveGoogleChatGroupToolPolicy as Wn, isCacheEnabled as Wt, stripPluginOnlyAllowlist as X, resolveTelegramGroupToolPolicy as Xn, normalizeSessionDeliveryFields as Xt, resolveToolProfilePolicy as Y, resolveTelegramGroupRequireMention as Yn, normalizeDeliveryContext as Yt, buildBootstrapContextFiles as Z, resolveWhatsAppGroupRequireMention as Zn, resolveSessionKey as Zt, isCompactionFailureError as _, GATEWAY_CLIENT_MODES as _n, listSignalAccountIds as _r, resolvePinnedHostname as _t, isMessagingToolDuplicateNormalized as a, deriveSessionMetaPatch as an, resolveTelegramToken as ar, normalizeReasoningLevel as at, isFailoverErrorMessage as b, listChannelPlugins as bn, listIMessageAccountIds as br, sanitizeToolResultImages as bt, downgradeOpenAIReasoningBlocks as c, INTERNAL_MESSAGE_CHANNEL as cn, listEnabledSlackAccounts as cr, normalizeVerboseLevel as ct, classifyFailoverReason as d, isMarkdownCapableMessageChannel as dn, resolveSlackAccount as dr, extractOriginalFilename as dt, resolveSessionResetPolicy as en, normalizeWhatsAppTarget as er, sanitizeGoogleTurnOrdering as et, formatAssistantErrorText as f, listDeliverableMessageChannels as fn, resolveSlackReplyToMode as fr, getMediaDir as ft, isCloudCodeAssistFormatError as g, GATEWAY_CLIENT_IDS as gn, listEnabledSignalAccounts as gr, createPinnedDispatcher as gt, isAuthAssistantError as h, resolveMessageChannel as hn, normalizeChatType as hr, closeDispatcher as ht, isMessagingToolDuplicate as i, resolveMainSessionKey as in, resolveTelegramAccount as ir, normalizeElevatedLevel as it, createBrowserRouteContext as j, normalizeSlackMessagingTarget as jn, resolveToolsBySender as jr, isGifMedia as jt, resolveSandboxContext as k, listWhatsAppDirectoryPeersFromConfig as kn, resolveChannelGroupRequireMention as kr, imageMimeFromFormat as kt, isAntigravityClaude as l, isDeliverableMessageChannel as ln, listSlackAccountIds as lr, resolveResponseUsageMode as lt, getApiErrorPayloadFingerprint as m, resolveGatewayMessageChannel as mn, resolveSlackBotToken as mr, SsrFBlockedError as mt, validateGeminiTurns as n, resolveThreadFlag as nn, listTelegramAccountIds as nr, formatXHighModelHint as nt, normalizeTextForComparison as o, resolveConversationLabel as on, listBindings as or, normalizeThinkLevel as ot, formatRawAssistantErrorForUi as p, normalizeMessageChannel as pn, resolveSlackAppToken as pr, saveMediaBuffer as pt, expandToolGroups as q, resolveSlackGroupRequireMention as qn, deliveryContextKey as qt, pickFallbackThinkingLevel as r, DEFAULT_RESET_TRIGGERS as rn, resolveDefaultTelegramAccountId as rr, listThinkingLevels as rt, sanitizeSessionMessagesImages as s, resolveGroupSessionKey as sn, buildSlackThreadingToolContext as sr, normalizeUsageDisplay as st, validateAnthropicTurns as t, resolveSessionResetType as tn, listEnabledTelegramAccounts as tr, formatThinkingLevels as tt, isGoogleModelApi as u, isInternalMessageChannel as un, resolveDefaultSlackAccountId as ur, supportsXHighThinking as ut, isContextOverflowError as v, GATEWAY_CLIENT_NAMES as vn, resolveDefaultSignalAccountId as vr, resolvePinnedHostnameWithPolicy as vt, isTimeoutErrorMessage as w, listSlackDirectoryGroupsFromConfig as wn, listEnabledDiscordAccounts as wr, optimizeImageToPng as wt, isLikelyContextOverflowError as x, normalizeChannelId as xn, resolveDefaultIMessageAccountId as xr, convertHeicToJpeg as xt, isFailoverAssistantError as y, getChannelPlugin as yn, resolveSignalAccount as yr, sanitizeImageBlocks as yt, resolvePluginSkillDirs as z, resolveBlueBubblesGroupRequireMention as zn, readSessionUpdatedAt as zt };