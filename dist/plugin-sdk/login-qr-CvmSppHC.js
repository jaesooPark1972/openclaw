...
import { I as success, M as info, U as toPinoLikeLogger, V as getChildLogger, _ as ensureDir, j as danger, s as logInfo, u as defaultRuntime, w as resolveUserPath } from "./exec-Cm9b2r9Q.js";
import { A as logoutWeb, C as VERSION, E as resolveWhatsAppAccount, F as resolveWebCredsPath, I as webAuthExists, M as readWebSelfId, N as resolveDefaultWebAuthDir, P as resolveWebCredsBackupPath, j as maybeRestoreCredsFromBackup, t as loadConfig } from "./config-ikIWdT6t.js";
...
async function startWebLoginWithQr(opts = {}) {
	...
	}, Math.max(opts.timeoutMs ?? 6e4, 5e3));
	let sock;
	let pendingQr = null;
	try {
