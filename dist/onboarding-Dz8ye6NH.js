...
import { _t as DEFAULT_MODEL, gt as DEFAULT_CONTEXT_TOKENS, l as resolveConfiguredModelRef, st as ensureAuthProfileStore, vt as DEFAULT_PROVIDER } from "./model-selection-DOOBF_0m.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-DELazozB.js";
import { c as writeConfigFile, i as loadConfig, j as VERSION, o as readConfigFileSnapshot } from "./config-Qw6Mvhjh.js";
import { n as listChannelPlugins } from "./plugins-QJjTXliB.js";
import { L as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-25YuSHUe.js";
import { d as inspectPortUsage, f as resolveLsofCommandSync, p as formatPortDiagnostics } from "./chrome-D7QROrKP.js";
import { o as resolveStorePath } from "./paths-B-q1nXdY.js";
import { t as buildChannelSummary } from "./channel-summary-CGMFM3Z4.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-CksrEJ-J.js";
import { n as withProgress } from "./progress-CvaSPjS9.js";
import { a as summarizeRestartSentinel, i as readRestartSentinel } from "./restart-sentinel-DUemCjgU.js";
import { a as findTailscaleBinary, o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-CBv58toW.js";
...
import { c as promptDefaultModel, h as applyAuthChoice, m as warnIfModelConfigLooksOff, p as resolvePreferredProviderForAuthChoice, r as promptRemoteGatewayConfig, s as applyPrimaryModel, t as setupSkills, u as ensureControlUiAssetsBuilt, v as promptAuthChoiceGrouped } from "./onboard-skills-CdIenoT7.js";
import { n as setupChannels } from "./onboard-channels-WFDLrVqO.js";
import { a as resolveHeartbeatSummaryForAgent, i as healthCommand, n as formatHealthChannelLines, t as formatHealthCheckFailure } from "./health-format-DXrJfeAq.js";
import { _ as formatUpdateChannelLabel, d as compareSemverStrings, l as ensureCompletionCacheExists, s as checkShellCompletionStatus, u as checkUpdateStatus, v as normalizeUpdateChannel, y as resolveEffectiveUpdateChannel } from "./update-runner-QzzUA0KV.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-B6VeUgJZ.js";
import { t as renderTable } from "./table-DS4-gmkV.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CENcKr3I.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-BZNBq9hq.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-0Qa_nGqe.js";
import { o as readLastGatewayErrorLine } from "./service-audit-CNchRGyi.js";
import { t as resolveNodeService } from "./node-service-DcJREOww.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-YohTjZ-I.js";
import { i as redactSecrets, n as formatDuration$1, r as formatGatewayAuthUsed, t as formatAge$1 } from "./format-Dzy9uRLE.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-lRMVWCDJ.js";
import { r as installCompletion } from "./completion-cli-BcR-O5fC.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Btx_rmAv.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-DX_2G6W8.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DKUFHcLn.js").then((n) => n.r);
