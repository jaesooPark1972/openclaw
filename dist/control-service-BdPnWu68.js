...
import { a as resolveBrowserConfig, o as resolveProfile, t as createBrowserRouteContext } from "./server-context-BFH7HB_M.js";
import { S as ensureChromeExtensionRelayServer } from "./errors-CMCg46fK.js";
...
async function stopBrowserControlService() {
	...
	state = null;
	try {
		await (await import("./pw-ai-08F3GD-3.js")).closePlaywrightBrowserConnection();
	} catch {}
}
