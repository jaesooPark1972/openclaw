...
**✅ 검증 완료:** 이 버전은 Windows 환경에서 정상 작동이 확인되었습니다 (2026.02.05)
...
### **2. 실시간 웹 검색 (Brave Search + 네이버 검색)**
...
- **명령 예시:**
  - "네이버에서 '강남 맛집' 검색해줘"
  - "네이버 뉴스에서 최신 IT 소식 찾아줘"
  - "네이버 블로그에서 '제주도 여행' 후기 검색해줘"
- **특징:** 한국어 콘텐츠와 로컬 정보에 최적화된 검색 결과 제공
...
- **문서 처리:** PDF, DOCX, TXT 파일 읽기 및 분석

### **5. 개발자 도구**

- **GitHub 연동:** 저장소 관리, 이슈 생성, PR 검토
- **API 테스트:** REST API 호출 및 응답 분석
- **데이터베이스:** Supabase 연동으로 데이터 조회/수정
- **브라우저 자동화:** 웹사이트 자동 조작 및 데이터 수집
